...
import { mockAuthAPI, mockChatAPI, mockWebSocketService } from './mockBackendService';

// Toggle mock mode
const USE_MOCK = !process.env.REACT_APP_API_BASE_URL || process.env.REACT_APP_USE_MOCK === 'true';

console.log(`[API Service] Mode: ${USE_MOCK ? 'MOCK' : 'REAL'} Backend`);
...
export const websocketService = USE_MOCK ? mockWebSocketService : {
